...
import { FiArrowRight, FiLock, FiShield, FiZap, FiGlobe, FiSmile, FiLogIn } from 'react-icons/fi';
            ...
            <div className="flex flex-col items-center gap-6 text-center">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-400 text-lg max-w-sm mx-auto">
                  Experience the future of crypto with our secure, fast, and intuitive Solana wallet
                </p>
              </div>
            </div>
                ...
                <>
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-2 bg-[#0F1113] text-gray-400">or</span>
                    </div>
                  </div>
